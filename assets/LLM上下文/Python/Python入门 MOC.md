...
> 🧭 首页 [[assets/LLM上下文/index|StudyVault]] · 相邻技能 [[assets/LLM上下文/LaTeX/LaTeX学习 MOC|LaTeX]]
>
...
> PINN 学习路径见 [[assets/LLM上下文/PINN/PINN学习 MOC|PINN 学习 MOC]]。
...
| # | 主题 | 笔记 | 速查 |
|---|------|------|------|
| 1 | 类型、控制流、输入输出 | [[笔记/技能/Python/01-基础语法/Python基础\|Python基础]] | [[assets/LLM上下文/Python/Quick Reference#基础\|基础]] |
| 2 | list / tuple / dict / set | [[笔记/技能/Python/02-数据结构/数据结构\|数据结构]] | [[assets/LLM上下文/Python/Quick Reference#数据结构\|数据结构]] |
| 3 | def、参数、lambda、模块、注解 | [[笔记/技能/Python/03-函数与模块/函数与模块\|函数与模块]] | [[assets/LLM上下文/Python/Quick Reference#函数与模块\|函数与模块]] |
| 4 | 类、继承、dunder、property | [[笔记/技能/Python/04-面向对象/面向对象\|面向对象]] | [[assets/LLM上下文/Python/Quick Reference#面向对象\|面向对象]] |
| 5 | 文件、with、pathlib、异常 | [[笔记/技能/Python/05-文件与异常/文件与异常\|文件与异常]] | [[assets/LLM上下文/Python/Quick Reference#文件与异常\|文件与异常]] |
...
> [!tip] 衔接 PINN
> 第 6、7 章是专为 PINN 学习新增的筑基章。PINN 学习路径见 [[assets/LLM上下文/PINN/PINN学习 MOC|PINN 学习 MOC]]——4 阶段 8~9 周从零基础走到跑通 Burgers / 方腔流 demo。
